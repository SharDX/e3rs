...
void setup_udp_header(struct udphdr *udph)
{
	...
	udph->dest = htons(7);
	udph->check = 0;
	char *udph_nxt_bytes = (char *)(udph + sizeof(struct udphdr));
	udph_nxt_bytes[0] = '\x0D';
	udph_nxt_bytes[1] = '\x0A';
	udph_nxt_bytes[2] = '\x0D';
	udph_nxt_bytes[3] = '\x0A';
